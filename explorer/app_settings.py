...
# To support integrations with Snowflake
EXPLORER_USE_SNOWFLAKE = getattr(settings, 'EXPLORER_USE_SNOWFLAKE', None)
EXPLORER_SNOWFLAKE_ACCOUNT_IDENTIFIER = getattr(settings, 'EXPLORER_SNOWFLAKE_ACCOUNT_IDENTIFIER', None)
EXPLORER_SNOWFLAKE_USER = getattr(settings, 'EXPLORER_SNOWFLAKE_USER', None)
EXPLORER_SNOWFLAKE_PASSWORD = getattr(settings, 'EXPLORER_SNOWFLAKE_PASSWORD', None)
EXPLORER_SNOWFLAKE_DATABASE = getattr(settings, 'EXPLORER_SNOWFLAKE_DATABASE', None)
EXPLORER_SNOWFLAKE_SCHEMA = getattr(settings, 'EXPLORER_SNOWFLAKE_SCHEMA', None)
EXPLORER_SNOWFLAKE_ROLE = getattr(settings, 'EXPLORER_SNOWFLAKE_ROLE', None)
EXPLORER_SNOWFLAKE_WAREHOUSE = getattr(settings, 'EXPLORER_SNOWFLAKE_WAREHOUSE', None)
